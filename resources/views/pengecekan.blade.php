    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8 text-center">
                <h1>Fitur Pengecekan</h1>
                <label> fitur untuk pengecekan dua free input dari user, dan system akan menghitung berapa
                    persen karakter dari input pertama ada di input kedua dan akan dimunculkan ke user.</label>
            </div>
            <div class="row">
                <div class="col">
                    <div class="container">
                        <form action="/calculateWord" method="post">
                            @csrf
                            <div class="mt-16">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pertama" placeholder="Masukkan Input Pertama" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kedua" placeholder="Masukkan Input Kedua">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
