            ...
            <table class="table">
                ...
                <tbody>
                    <form action="/store" method="post">
                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Hewan">
                            </td>
                            <td>
                                <input type="text" class="form-control" name="species" placeholder="Masukkan Species Hewan">
                            </td>
                            <td>
