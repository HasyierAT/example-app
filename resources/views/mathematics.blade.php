    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8 text-center">
                <h1>Module Mathematics</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="container">
                    <form action="/calculateMath" method="post">
                        @csrf
                        <div class="mt-16">
                            <div class="row">
                                <div class="col-10">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="pertama" placeholder="Masukkan Angka Pertama" required>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="kedua" placeholder="Masukkan Angka Kedua" required>
                                    </div>
                                </div>
                            </div>
