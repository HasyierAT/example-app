        ...
        <div class="row">
            ...
            <div class="container text-center">
                <table class="table">
                    ...
                    <tbody>
                        @foreach($detailAnimal as $detAni)
                        <form action="/update/{{ $detAni -> id }}" method="post">
                            @csrf
                            <tr>
                                <td>
                                    <input type="text" class="form-control" name="updateName" placeholder="{{ $detAni -> name }}">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="updateSpecies" placeholder="{{ $detAni -> species }}">
                                </td>
                                <td>
